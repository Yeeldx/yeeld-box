# @version 0.2.12
"""
@title Yeeldx Token Vault
@license GNU AGPLv3
@author Yeeldx.finance
@notice
    Yeeldx Token Vault. Holds an underlying token, and allows users to interact
    with the Yeeldx ecosystem through Strategies connected to the Vault.
    ...
    https://github.com/iearn-finance/Yeeldx-vaults/blob/main/SPECIFICATION.md
"""
...
def initialize(
    ...
    @dev
        If `nameOverride` is not specified, the name will be 'yeeldx'
    ...
    self.DOMAIN_SEPARATOR = keccak256(
        concat(
            DOMAIN_TYPE_HASH,
            keccak256(convert("yeeldx Vault", Bytes[11])),
...
def apiVersion() -> String[28]:
    ...
    @notice
        ...
        can use this version number to compare with yeeldx's GitHub and
